<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="卡类编号" prop="code">
        <el-input
      ...
      <el-form-item label="卡类次" prop="status">
        <el-select v-model="queryParams.status" placeholder="请选择卡类次" clearable size="small">
          <el-option
            v-for="dict in dict.type.sys_normal_disable"
            :key="dict.value"
            :label="dict.label"
    ...
    <el-table v-loading="loading" :data="serviceList" >
      <el-table-column label="卡类编号" align="center" prop="code" />
      <el-table-column label="卡类名称"  align="center" prop="name" width="150" :show-overflow-tooltip="true" />
      <el-table-column label="分类名称" align="center" prop="serviceClass.name" />
      <el-table-column label="卡类次" align="center" prop="durationHour">
    ...
    >
      ...
      >
       <el-form-item label="卡类编号" prop="code">
        ...
        <el-form-item label="卡类分类" prop="classIdArr">
      ...
      >
        ...
        <el-table-column label="卡类图片" align="center">
          <template slot-scope="scope">
            <el-image
        ...
        <el-table-column label="卡类编号" align="center" prop="serviceCode" />
        <el-table-column
          label="卡类名称"
          align="center"
          prop="serviceName"
        ...
        />
        <el-table-column label="卡类分类" align="center" prop="serviceClass" />
