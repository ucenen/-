<template>
  <div>
    ...
    >
      ...
      <el-form-item label="提成类别" prop="saleCommiWay">
        <el-select
          v-model="queryParams.saleCommiWay"
          placeholder="请选择提成类别"
          clearable
          size="small"
        >
    ...
    >
      <el-form ref="form" :model="form" :rules="rules" label-width="auto">
        ...
        <el-row>
          <el-col :span="13">
            <el-form-item prop="saleCommiWay" label="提成类别">
              <el-select
                v-model="form.saleCommiWay"
                placeholder="请选择提成类别"
                clearable
                size="small"
              >
...
<script>
import { listClass } from "@/api/store/base/goods_class";
import {
...
import {
  addCommissionSaleInfo,
  getCommissionSaleList,
...
export default {
  ...
  methods: {
    getList() {
      getCommissionSaleList(this.queryParams).then((res) => {
        console.log(res);
        ...
        let payload = _.assign(
          {
            ...
            deptId: this.deptId,
            saleCommiWays: [this.form.saleCommiWay],
          },
          this.form,
          {
