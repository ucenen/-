<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="套餐次" prop="status">
        <el-select v-model="queryParams.status" placeholder="请选择套餐次" clearable size="small">
          <el-option
            v-for="dict in dict.type.sys_normal_disable"
            :key="dict.value"
            :label="dict.label"
    ...
    <el-table v-loading="loading" :data="serviceList" >
      <el-table-column label="套餐编号" align="center" prop="code" />
      <el-table-column label="套餐名称"  align="center" prop="name" width="150" :show-overflow-tooltip="true" />
      <el-table-column label="分类名称" align="center" prop="serviceClass.name" />
      <el-table-column label="套餐次" align="center" prop="durationHour">
    ...
    >
      ...
      >
        ...
        <el-table-column label="套餐编号" align="center" prop="serviceCode" />
        <el-table-column
          label="套餐名称"
          align="center"
          prop="serviceName"
        ...
        />
        <el-table-column label="套餐分类" align="center" prop="serviceClass" />
