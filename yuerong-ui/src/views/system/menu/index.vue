<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch">
      <el-form-item label="所属系统" prop="system">
        <el-select v-model="queryParams.system" placeholder="所属系统" clearable size="small">
          <el-option
            v-for="dict in dict.type.sys_system"
            :key="dict.value"
            :label="dict.label"
            :value="dict.value"
          />
    ...
    >
      ...
      <el-table-column prop="system" label="所属系统" width="80">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.sys_system" :value="scope.row.system"/>
        </template>
      </el-table-column>
          ...
          <el-col :span="24">
            <el-form-item label="所属系统" prop="system">
              <el-radio-group v-model="form.system">
                <!-- el-radio :key=1 :label=1>总部端</el-radio>
                <el-radio :key=2 :label=2>员工端</el-radio>
                <el-radio :key=3 :label=3>收银端</el-radio -->
                <el-radio
                  v-for="dict in dict.type.sys_system"
                  :key="dict.value" 
...
export default {
  name: "Menu",
  dicts: ['sys_show_hide', 'sys_normal_disable', 'sys_system'],
