  ...
  <div class="app-container">
    ...
    <el-dialog :title="title" :visible.sync="open" width="600px" append-to-body :close-on-click-modal="false">
      <el-form ref="form" :model="form" :rules="rules" label-width="auto">
        <el-row>
          <el-col :span="12">
            <el-form-item label="用户昵称" prop="nickName">
              <el-input v-model="form.nickName" @blur="form.nickName=$event.target.value.trim()" placeholder="请输入用户昵称" maxlength="30" show-word-limit/>
            </el-form-item>
          </el-col>
          <el-col :span="12">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item v-if="form.userId == undefined" label="" prop="userName">
              <span slot="label">
                                                 用户名称
                <el-tooltip content="登录账户名" placement="top">
                <i class="el-icon-question"></i>
                </el-tooltip>
              </span>
              <el-input v-model.trim="form.userName" placeholder="请输入用户名称" maxlength="30" show-word-limit />
            </el-form-item>
          </el-col>
          <el-col :span="12">
...
<script>
import { listUser, getUser, getInfos, delUser, addUser, updateUser, resetUserPwd, changeUserStatus } from "@/api/system/user";
